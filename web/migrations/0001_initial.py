    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('asset', models.OneToOneField(default=None, to='web.Asset')),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('encoder_name', models.CharField(default=b'server', unique=True, max_length=100)),
                ('output_name', models.CharField(max_length=100)),
            ],
            options={
                'db_table': 'web_encoderstatus',
            },
            bases=(models.Model,),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('os_version', models.CharField(max_length=64, null=True, verbose_name='\u64cd\u4f5c\u7cfb\u7edf\u7248\u672c', blank=True)),
                ('create_at', models.DateTimeField(auto_now_add=True, null=True)),
                ('update_at', models.DateTimeField(auto_now_add=True, null=True)),
                ('asset', models.OneToOneField(to='web.Asset')),
                ('cpu_model', models.ForeignKey(to='web.CPU')),
                ('nic', models.ManyToManyField(to='web.NIC', verbose_name='\u7f51\u5361\u5217\u8868')),
                ('physical_disk_driver', models.ManyToManyField(to='web.Disk', verbose_name='\u786c\u76d8', blank=True)),
                ('raid_adaptor', models.ManyToManyField(to='web.RaidAdaptor', verbose_name='Raid\u5361', blank=True)),
                ('ram', models.ManyToManyField(to='web.Memory', verbose_name='\u5185\u5b58\u914d\u7f6e', blank=True)),
            ],
            options={
                'verbose_name': '\u670d\u52a1\u5668',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('status', models.SmallIntegerField(unique=True, verbose_name='\u8bbe\u5907\u72b6\u6001', choices=[(1, b'Init'), (2, b'Standby'), (3, b'Online'), (4, b'Offline'), (5, b'Unreachable'), (6, b'Deprecated'), (7, b'Maintenance')])),
                ('os_installed', models.BooleanField(default=False)),
                ('puppet_installed', models.BooleanField(default=False)),
                ('zabbix_configured', models.BooleanField(default=False)),
                ('auditing_configured', models.BooleanField(default=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('server_group', models.CharField(default=b'none', max_length=10)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_at', models.DateTimeField(auto_now_add=True)),
                ('update_at', models.DateTimeField(auto_now=True)),
                ('backup_name', models.ForeignKey(related_name='user_backup_name', verbose_name='\u5907\u7528\u8054\u7cfb\u4eba', blank=True, to='web.UserProfile', null=True)),
                ('business_unit', models.ManyToManyField(to='web.BusinessUnit')),
                ('leader', models.ForeignKey(verbose_name=b'\xe4\xb8\x8a\xe7\xba\xa7\xe9\xa2\x86\xe5\xaf\xbc', blank=True, to='web.UserProfile', null=True)),
        ...
        migrations.AddField(
            ...
            name='firmware',
            field=models.ForeignKey(to='web.Software'),
        ...
        migrations.AddField(
            ...
            name='applicant',
            field=models.ForeignKey(related_name='applicant_user', verbose_name='\u53d1\u8d77\u4eba', to='web.UserProfile'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='maintainence',
            name='performer',
            field=models.ForeignKey(verbose_name='\u6267\u884c\u4eba', to='web.UserProfile'),
            preserve_default=True,
        ),
        migrations.AlterUniqueTogether(
            name='disk',
        ...
        migrations.AddField(
            ...
            name='nic',
            field=models.ManyToManyField(to='web.NICConfig', verbose_name='\u7f51\u5361\u5217\u8868', blank=True),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='configuration',
            name='os',
            field=models.ForeignKey(verbose_name=b'OS', blank=True, to='web.Software', null=True),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='businessunit',
            name='contact',
            field=models.ForeignKey(default=None, blank=True, to='web.UserProfile', null=True),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='asset',
            name='admin',
            field=models.ForeignKey(related_name='+', verbose_name='\u8bbe\u5907\u7ba1\u7406\u5458', blank=True, to='web.UserProfile', null=True),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='asset',
            name='business_unit',
            field=models.ForeignKey(verbose_name='\u5c5e\u4e8e\u7684\u4e1a\u52a1\u7ebf', blank=True, to='web.BusinessUnit', null=True),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='asset',
            name='business_unit_level2',
            field=models.ForeignKey(verbose_name='2\u7ea7\u4e1a\u52a1\u7ebf', blank=True, to='web.BusinessUnitLevel2', null=True),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='asset',
            name='contract',
            field=models.ForeignKey(verbose_name='\u5408\u540c', blank=True, to='web.Contract', null=True),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='asset',
            name='idc',
            field=models.ForeignKey(verbose_name='IDC\u673a\u623f', blank=True, to='web.IDC', null=True),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='asset',
            name='status',
            field=models.ForeignKey(default=1, verbose_name='\u8bbe\u5907\u72b6\u6001', to='web.Status'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='apiauth',
            name='users',
            field=models.ManyToManyField(to='web.UserProfile', null=True),
            preserve_default=True,
        ),
        migrations.AlterUniqueTogether(
            name='apiauth',
